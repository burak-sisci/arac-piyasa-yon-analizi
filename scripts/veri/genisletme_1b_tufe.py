...
BASLANGIC_AY = "2015-01"  # genisletme hedefi: 2015-01'e kadar geriye git (taban ay, ilk ayin aylik degisimi icin gerekliyse ayrica -1 ay istenir)
BITIS_AY = date.today().strftime("%Y-%m")
HEDEF_BASLANGIC_AY = "2015-01"
