...
- Ağır literatür taramaları Codex.ai Deep Research'te yapılır; çıktılar bu repoya
  taşınır. Codex'un görevi: organizasyon, tutarlılık kontrolü, sentez,
...
```
.
├── AGENTS.md                  # bu dosya — her oturumda bağlam
...
Codex tarafından onay beklenmeden uçtan uca yürütülür; proje sahibi
